...
?>
       ...
       <?php echo $this->fetch('library/pages.lbi'); ?>
       <div class="blank5"></div>
       <h5 style="display:none"><span><?php echo $this->_var['lang']['merge_order']; ?></span></h5>
       <div class="blank"></div>
        <script type="text/javascript">
...
?>
        ...
        <form action="user.php" method="post" name="formOrder" onsubmit="return mergeOrder()" style="display:none">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
